...
def update_actor_critic_rnn(
    ...
    Args:
        ...
        train_state (TrainState):
        init_hstate (chex.ArrayTree):
        batch (chex.ArrayTree): obs, actions, dones, log_probs, values, targets, advantages, env_weights
        num_envs (int):
        n_steps (int):
        n_minibatch (int):
        n_epochs (int):
    ...
    def update_epoch(carry, _):
        ...
        # n_env / n_minibatch envs per minibatch
        # default envs is 32 (n_minibatch = 1)
...
def main(config=None, project="JAXUED_TEST"):
    ...
    def train_step(carry: Tuple[chex.PRNGKey, TrainState], _):
        ...
        (rng, train_state), losses = update_actor_critic_rnn(
            ...
            train_state,
            train_state.last_hstate,
            (obs, actions, dones, log_probs, values, targets, advantages, env_weights),
            config["num_train_envs"],
            config["num_steps"],
